...
setwd("~/Dropbox/University of Toronto/Research Related/R outputs/Two Patch Elmhirst extended/Heterogeneous_Grazing/") #heterogeneous grazing folder
...
#stable only
pdf(paste0("StableOnly_Heterograz_DispersalBifurcationGraph_g",gval,"grazinglevel",g_level,".pdf"))
plot(x = twopatch_ext_complete$p_c[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level & twopatch_ext_complete$ID > 0], y = twopatch_ext_complete$C1[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level & twopatch_ext_complete$ID > 0], col = twopatch_ext_complete$Colour[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level & twopatch_ext_complete$ID > 0], xlim = c(0,1), ylim = c(0,1), pch = 16, xlab = "dispersal level", ylab = "C cover", main = paste("Only Stable Nodes, g = ", gval, "and g_level =", g_level))
legend("topleft", c("Stable Node", "Unstable Node", "Saddle", "Bifurcation Point?"), col = c("black","gold","purple","green"), pch = c(20,20))
dev.off()

#all
pdf(paste0("Heterograz_DispersalBifurcationGraph_g",gval,"grazinglevel",g_level,".pdf")) 
plot(x = twopatch_ext_complete$p_c[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level], y = twopatch_ext_complete$C1[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level], col = twopatch_ext_complete$Colour[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level], xlim = c(0,1), ylim = c(0,1), pch = 16, xlab = "dispersal level", ylab = "C cover", main = paste("g = ", gval, "and g_level =", g_level))
legend("topleft", c("Stable Node", "Unstable Node", "Saddle", "Bifurcation Point?"), col = c("black","gold","purple","green"), pch = c(20,20))
dev.off()

#transparent
pdf(paste0("TransparentHeterograz_DispersalBifurcationGraph_g",gval,"grazinglevel",g_level,".pdf"))
plot(x = twopatch_ext_complete$p_c[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level], y = twopatch_ext_complete$C1[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level], col = alpha(twopatch_ext_complete$Colour[twopatch_ext_complete$g == gval & twopatch_ext_complete$g2 == g_level],0.4), xlim = c(0,1), ylim = c(0,1), pch = 16, xlab = "dispersal level", ylab = "C cover", main = paste("g = ", gval, "and g_level =", g_level))
legend("topleft", c("Stable Node", "Unstable Node", "Saddle", "Bifurcation Point?"), col = alpha(c("black","gold","purple","green"),0.4), pch = c(20,20))
dev.off()
	}
}
